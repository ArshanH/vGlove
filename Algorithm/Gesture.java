...
public class Gesture {
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        DataParser parser = new DataParser(false);

        Gesture newGest = Learner.createGesture("handup", "../GesturesBIN/handup.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("flat", "../GesturesBIN/flat.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("middlefinger", "../GesturesBIN/middlefinger.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("thumbsup", "../GesturesBIN/thumbsup.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("five", "../GesturesBIN/five.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("four", "../GesturesBIN/four.txt.bin");
        newGest.writeToFile(file);
        /*
        newGest = Learner.createGesture("three", "../GesturesBIN/three.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("two", "../GesturesBIN/two.txt.bin");
        newGest.writeToFile(file);
        newGest = Learner.createGesture("one", "../GesturesBIN/one.txt.bin");
        newGest.writeToFile(file);
*/
    }
